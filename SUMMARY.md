...
* [Template Based Content Creation](content-development-principles/4.2-template-based-content-creation/README.md)
  ...
  * [Quality Observable with Susceptibility](content-development-principles/4.2-template-based-content-creation/4.2.7-quality-observable-with-susceptibility/README.md)
...
* [Using the LOINC Ontology](technical-application/6.4-using-the-loinc-ontology/README.md)
  ...
  * [6Accessing the LOINC Ontology from a FHIR Terminology Server](technical-application/6.4-using-the-loinc-ontology/6.4.2-accessing-the-loinc-ontology-from-a-fhir-terminology-server.md)
