...
* [4.2.2 Quality Observable with Inheres in (System, no Component)](broken-reference)
* [4.2.3 Quality Observable with Inheres In](broken-reference)
* [4.2.4 Quality Observable with Process](broken-reference)
* 4.2.5 Quality Observable with Ratio
* [4.2.6 Quality Observable with Relative to](broken-reference)
* [4.2.7 Quality Observable with Susceptibility](broken-reference)
* [4.2.8 Quality Observable with Process (No Process output, With Time aspect)](broken-reference)
