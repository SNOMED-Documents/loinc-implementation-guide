...
The java implementation of this template can be found: [http://github.com/IHTSDO/reporting-engine/blob/2025\_Q4/script-engine/src/main/java/org/ihtsdo/termserver/scripting/pipeline/loinc/template/LoincTemplatedConceptWithComponent.java](http://github.com/IHTSDO/reporting-engine/blob/2025_Q4/script-engine/src/main/java/org/ihtsdo/termserver/scripting/pipeline/loinc/template/LoincTemplatedConceptWithComponent.java)
...
LOINC Properties currently supported: "ACnc", "CCnc", "CCnt", "LaCnc", "LnCnc", "LsCnc", "MCnc", "MCnt", "MoM", "NCnc", "Naric", "PrThr", "SCnc", "SCnt", "Titr", "ACnt", "Num", "ThreshNum", "MSCnc", "SCncDiff"
