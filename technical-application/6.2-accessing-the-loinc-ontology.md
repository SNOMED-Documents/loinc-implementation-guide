...
Each version of a SNOMED CT extension depends on a specific version of the International Edition (refer to section [4.2.2 Module Dependencies](https://confluence.ihtsdotools.org/display/DOCEXTPGPT/4.2.2+Module+Dependencies) for more details). Therefore, deploying the LOINC ontology requires access to both the LOINC ontology release package and the corresponding International Edition release package, upon which the specific version of the LOINC ontology is dependent.
