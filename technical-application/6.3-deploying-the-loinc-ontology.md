...
| <table data-header-hidden><thead><tr><th></th></tr></thead><tbody><tr><td><img src="../.gitbook/assets/278302113.png" alt=""></td></tr></tbody></table> |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](../.gitbook/assets/278302113.png)                                                                                                                   |
...
| <table data-header-hidden><thead><tr><th></th></tr></thead><tbody><tr><td><img src="../.gitbook/assets/278302115.png" alt=""></td></tr></tbody></table> |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](../.gitbook/assets/278302115.png)                                                                                                                   |
...
| <table data-header-hidden><thead><tr><th></th></tr></thead><tbody><tr><td><img src="../.gitbook/assets/278302111.png" alt=""></td></tr></tbody></table> |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](../.gitbook/assets/278302111.png)                                                                                                                   |
...
| **3. Historical Tracking and Concept Mapping**                        | Identify inactive concept references in maps.                                                                                       | <p>^ (&#x3C;  <a href="http://snomed.info/id/900000000000496009">900000000000496009 |Simple map from SNOMED CT type reference set (foundation metadata concept)|</a> ){{ C active=0}}<br></p> | _Note that this ECL only retrieves the members of simple map from SNOMED CT type reference set. If other types are required, the concept id for those types can be applied._                                                                                                                                                                                                                      |
